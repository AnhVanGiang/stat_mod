...
f <- function(x) {
  return(theta[1] * x + theta[2] / (theta[3] + 3*x^2))
} 
...
plot(x,y,xlab="Values for x",ylab="Values for y") # plot of dataset

nmodel=nls(form,data=y,start=c(theta1=theta[1],theta2=theta[2],theta3=theta[3])) 
```
