...
&= \frac{1}{2\pi} \left(\gamma_X(0) + 2\sum_{h = 1}^{2} \gamma_X(h)e^{-ih\lambda}   \right)\\
&= \frac{1}{2\pi} \left(\sigma^2 \sum_{i=0}^2\beta_i^2 + 2\sum_{h = 1}^{2} \gamma_X(h)e^{-ih\lambda}   \right)\\
&= \frac{1}{2\pi} \left(\frac{\sigma^2}{2} + 2\gamma_X(1)e^{-i\lambda} + 2\gamma_X(2)e^{-i2\lambda}   \right)\\
&= \frac{1}{2\pi} \left(\frac{\sigma^2}{2} + 2\sigma^2 (\beta_0 \beta_{1} + \beta_{1}\beta_{2}) e^{-i\lambda} + 2\sigma^2(\beta_0 \beta_2)e^{-i2\lambda}   \right)\\
&= \frac{1}{2\pi}  \left(\frac{\sigma^2}{2} + 2\sigma^2 (0) e^{-i\lambda} + - \frac{\sigma^2}{2}e^{-i2\lambda}   \right)\\
&= \frac{1}{2\pi}  \left(\frac{\sigma^2}{2} + - \frac{\sigma^2}{2}e^{-i2\lambda}   \right)
\end{align*}
...
of the fit 
```{r, echo=TRUE, include=TRUE}
Box.test(resid(arma.mle),type="Box-Pierce")$p.value
